...
<main className="fondo">
    ...
    <section className="relative flex justify-center min-h-screen  lg:pt-40 px-8">
        <h1 className=" animate__animated animate__fadeIn home-texto sm:text-2xl  md:text-6xl lg:text-10xl text-white align-middle text-center	 font-bold cursive leading-none lg:leading-snug home-name">{homeData.ctitle}</h1>
    </section>
</main>)
};